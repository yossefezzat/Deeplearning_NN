...
def build_model(n_layers=[], activ_func_layers=[] , pooling=[]):
...
def k_fold_arch_CNN(n_layers, activ_func_layers,pooling , k_fold):
    history_acc = []
    model = build_model(n_layers, activ_func_layers , pooling)
    models.append(model)
...
accuraices = []
def experiment(n_layers, activ_func_layers,pooling, k_fold=3):
    history_acc = k_fold_arch_CNN(n_layers, activ_func_layers, pooling , k_fold)
